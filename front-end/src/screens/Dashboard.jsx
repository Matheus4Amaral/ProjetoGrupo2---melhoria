...
export default function Dashboard() {
  ...
  async function fetchDashboardData() {
    try {
      ...
      setDashboardData({
        ...
        salesEvolution: Array.isArray(data.salesEvolution)
          ? data.salesEvolution
          : [],
  ...
  const chartSeries = [
    {
      name: "Vendas",
      data: (dashboardData.salesEvolution ?? []).map((item) =>
        Number(item.total_vendas),
      ),
    },
  ];
          ...
          <div className="dashboard-informations">
            <div className="dashboard-cards">
              <div className="total-products">
                <img
                  src={ProductLogo}
                  alt="Logo de Produtos Dashboard"
                ...
                <hr></hr>
                <span>
                  +{dashboardData.recentProducts} itens adicionados nos últimos
                  dias
                </span>
              </div>
              <div className="total-sales">
                ...
                <hr></hr>
                <span>
                  +{dashboardData.recentSales} vendas realizadas nos últimos
                  dias
                </span>
              </div>
            </div>
            ...
            <div className="dashboard-cards">
              <div className="stock-card">
                ...
                <div className="stock-list">
                  ...
                  {lowStockProducts.slice(0, 2).map((item) => {
                    const percent =
                      item.total > 0 ? (item.atual / item.total) * 100 : 0;

                    return (
                      <>
                        <div
                          className="list-row"
                          key={`${item.id_produto}-${item.id_estoque}`}
                        >
              ...
              <div className="supplier-card">
                <img
                  src={SupplierLogo}
                  alt="Logo de Fornecedores Dashboard"
                ...
                <hr></hr>
                <span>
                  +{dashboardData.totalSuppliers} fornecedores cadastrados nos
                  últimos dias
                </span>
              </div>
            </div>
